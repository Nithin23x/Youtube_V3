...
import { Check, CheckCircle, VideoFileSharp } from "@mui/icons-material"

import { demoThumbnailUrl,demoVideoTitle,demoVideoUrl, demoChannelUrl,demoChannelTitle } from "../utils/constants"

const VideoCard = ({video:{ id : {videoId , kind }, snippet }} ) => {
  ...
  return (
    <Card sx={{
      width : {xs:'100%',md:'320px'  }, boxShadow:'none' , borderRadius:0
    }}>
